...
import com.example.android.authentication.shrine.ui.viewmodel.HomeViewModel
...
fun MainMenuScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.padding(dimensionResource(R.dimen.dimen_32)))
...
private fun MainMenuButtonsList(
    ...
    Column(
        modifier = Modifier.padding(dimensionResource(R.dimen.dimen_20)),
