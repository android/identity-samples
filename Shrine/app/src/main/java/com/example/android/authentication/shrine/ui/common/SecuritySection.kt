...
fun SecuritySection(
    ...
    Column(
        modifier = modifier.padding(dimensionResource(R.dimen.dimen_12)),
        ...
        Spacer(modifier = Modifier.padding(top = dimensionResource(R.dimen.dimen_4)))
        ...
        ChangePasswordSection(
            ...
            modifier = modifier
                .height(dimensionResource(R.dimen.dimen_72))
