...
fun LearnMoreScreen(
    ...
    Column(
        ...
        Text(
            ...
            modifier = Modifier.padding(horizontal = dimensionResource(R.dimen.dimen_24), vertical = dimensionResource(R.dimen.dimen_12)),
        )
        Text(
        ...
        Text(
            ...
            modifier = Modifier.padding(horizontal = dimensionResource(R.dimen.dimen_24), vertical = dimensionResource(R.dimen.dimen_4)),
        )
        Text(
        ...
        Spacer(Modifier.padding(dimensionResource(R.dimen.dimen_8)))
